import { PromptTemplateDef } from './types';
...
- Крючок (первые 3 секунды) строится на парадоксе или неожиданном переосмыслении привычного утверждения
...
export const PROMPT_DEFINITIONS: PromptTemplateDef[] = [
  {
...
export async function fetchPromptDefinitions(): Promise<PromptTemplateDef[]> {
  try {
